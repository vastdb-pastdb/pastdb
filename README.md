...
Code and data associated with the PastDB web and publication ([Martín et al, *Genome Biol* 2021](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-020-02258-y)). For any further enquires, please feel free to contact Manuel Irimia (mirimia@gmail.com) and/or Guiomar Martín (guiomarm@igc.gulbenkian.pt). Additional information can be found in [PastDB](http://pastdb.crg.eu).
